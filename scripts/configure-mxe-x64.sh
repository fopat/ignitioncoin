...
# MXE env path
MXE_BASEPATH=/mnt/mxe-build-x64
...
make -j$NB_CORES MXE_TARGETS="x86_64-w64-mingw32.static" boost
echo -e "\n${GREEN}Building QT5${NC}"
make -j$NB_CORES MXE_TARGETS="x86_64-w64-mingw32.static" qttools
...
CC=\$MXE_PATH/usr/bin/x86_64-w64-mingw32.static-gcc \\
CXX=\$MXE_PATH/usr/bin/x86_64-w64-mingw32.static-g++ \\
../dist/configure \\
	--disable-replication \\
	--enable-mingw \\
	--enable-cxx \\
...
CC=\$MXE_PATH/usr/bin/x86_64-w64-mingw32.static-gcc \\
AR=\$MXE_PATH/usr/bin/x86_64-w64-mingw32.static-ar \\
